        ...
        {({ values, handleChange, handleBlur, setFieldValue }) => (
          <Form>
            <div className='bg-white dark:bg-gray-800 p-7 my-2 drop-shadow-md rounded-lg'>
              <div className="flex flex-wrap">
                <div className=" w-96 px-3">
                  {/*input field for create a group name  */}
                  ...
                  {/*component to show error massage of validation */}
                  <ErrorMessage
                ...
                <div className="w-full my-2 px-3">
                  ...
                  {/*input field for Add description */}
                  <Field
                    as="textarea"
                    id="description"
                    name='description'
            ...
            <FieldArray
              ...
              render={(arrayHelpers) => (
                <div className='bg-white dark:bg-gray-800 p-7 my-4 drop-shadow-md rounded-lg'>
                  ...
                  {/*Add more button to add a new term */}
            ...
            <div className="h-28 flex  items-center justify-center">
              {/*create button to create a flashcard */}
              <button type='submit'
